...
app.get("/", (req, res) => res.json({ status: "online", service: "Amphoracle Watcher v3.0", oracle: "watching", scheduled: scheduled.size, uptime: Math.floor(process.uptime()) }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => console.log(`\n🏺 Amphoracle Watcher v3.0 — Port ${PORT}\n`));
